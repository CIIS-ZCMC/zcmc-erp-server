            ...
            <pre>
{
    ...
    "metadata": {
...

        {
            "name": "New Unit",
            "code": "NU",
            "description": "A new item unit for testing."
        }
...

{
    "item_units": [
        ...
        },
        {
            "name": "Pound",
            "code": "LB",
            "description": "A unit of weight commonly used in the United States."
        },
        {
            "name": "Ounce",
            "code": "OZ",
            "description": "A unit of weight equal to one-sixteenth of a pound."
        }
    ]
}
                <button class="copy-button" onclick="copyToClipboard('{{ env('SERVER_DOMAIN') }}/api/item-units')">
            ...
            <pre>
{
    ...
    "message": "Bulk item units created successfully."
}
            </pre>
