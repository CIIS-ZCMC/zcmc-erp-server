    ...
    public function rules(): array
    {
        ...
        if ($this->input('status') !== 'draft') {
            $rules = array_merge($rules, [
                ...
                'application_objectives.*.id' => 'nullable',
                ...
                'application_objectives.*.activities.*.id' => 'nullable',
                ...
                'application_objectives.*.activities.*.target.id' => 'nullable',
                ...
                'application_objectives.*.activities.*.resources.*.id' => 'nullable',
                ...
                'application_objectives.*.activities.*.responsible_people.*.id' => 'nullable',
